...
def setup():
    ...
    p1_robotmania = model.Project("Robot Mania", url_for('p1_robotmania_bp.index'), "/static/img/p1_robotmania.png", "Robot Mania",
                             ...
                             "The main focus of our project was to make a bunch of fun minigames and a caluclator. There are some other activities "
                             "but we will mainly be showing calculator here.")
