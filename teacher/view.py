...
@teacher_bp.route('/')
def index():
    return render_template("teacher/home.html", projects=setup())


# connects /hello path of server to render hello.html
@teacher_bp.route('/hello/')
def hello_route():
    return render_template("teacher/hello.html", projects=setup())


# connects /flask path of server to render flask.html
@teacher_bp.route('/flask/')
def flask_route():
    return render_template("teacher/flask.html", projects=setup())
...
def about_route():
    return render_template("teacher/taskall.html", datalist=alldata())


@teacher_bp.route("/maps/")
def maps_route():
    return render_template("teacher/maps.html")
